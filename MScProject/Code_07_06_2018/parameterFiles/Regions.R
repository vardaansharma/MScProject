...
cat("***********\n")
cat("Loading Bridging Schemouyge: ", Scheme, " defined in 'Regions.R' \n")
cat("***********\n")
...
if( Scheme == 1 ){
    ...
    Xmin[1] = 0.0; Xmax[1] = 0.5; Ymin[1] = 0.325; Ymax[1] = 1.0; quad[1] = 1; quadName[1] = "ul";
    # Xmin[2] = 0.5; Xmax[2] = 1.0; Ymin[2] = 0.5; Ymax[2] = 1.0; quad[2] = 2; quadName[2] = "ur";
    Xmin[2] = 0.5; Xmax[2] = 1.0; Ymin[2] = 0.325; Ymax[2] = 1.0; quad[2] = 2; quadName[2] = "ur";
    ...
    Gseg1 <- geom_segment(aes(x=Xmin[1],xend=Xmax[1],y=0.1,yend=0.1),colour="grey40",size=1,linetype=2,show.legend=F)
