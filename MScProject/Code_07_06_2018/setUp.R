...
mainDir <- "/afs/inf.ed.ac.uk/user/c/cmclean5/WORK/DATA/Human_synaptosome_20_11_2017"
...
rndDIR[1] <- "/disk/scratch/WORK/DATA/Human_synaptosome_20_11_17"
...
S     <- Graph[which(as.vector(Graph[,1]) == 1)[1],2]
S     <- grep(S,subDIR)
