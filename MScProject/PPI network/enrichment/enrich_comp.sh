...
#./run -opt 2 -Comfile ../clustering/Clustering/PPI_Network/sgG5_communities.csv -Annofile Annotations/flatfile.go.BP.csv -Annofile Annotations/flatfile_human_gene2HDO.csv -ext BPvsDisb -o OUT/Comparisions/min2 -setFDR BY -maxSS -Chi2
...
./run -opt 2 -Comfile ../clustering/Clustering/PPI_Network/sgG5_communities.csv -Annofile Annotations/flatfile.go.BP.csv -Annofile Annotations/flatfile.DE.sep.csv -ext BPvsDE_count -o OUT/Comparisions/min2 -setFDR BY -maxSS -Chi2
...
#./run -opt 2 -Comfile ../clustering/Clustering/PPI_Network/sgG5_communities.csv -Annofile Annotations/flatfile_human_gene2HDO.csv -Annofile Annotations/flatfile.DE.sep.csv -ext DEvsDis_count -o OUT/Comparisions/min2 -setFDR BY -maxSS -Chi2
